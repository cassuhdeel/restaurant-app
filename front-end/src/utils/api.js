...
const API_BASE_URL =
   process.env.REACT_APP_API_BASE_URL || 'https://restaurant-cassidy-backend.herokuapp.com/'
...
export async function changeReservation(reservation_id, reservation, signal) {
...
export async function tableComplete(table_id, signal) {
